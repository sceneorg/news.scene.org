...
class Sideload
{
  ...
  function RequestCURL( $url, $method = "GET", $contentArray = array(), $headerArray = array() )
  {
	...
	{
		curl_setopt($curl, CURLOPT_COOKIEJAR, $this->options["cookiejar"]); 
		curl_setopt($curl, CURLOPT_COOKIEFILE, $this->options["cookiejar"]);		
	}
    ...
    if ($html === false)
    {
      ...
      $this->errorText = curl_error($curl);
    }
